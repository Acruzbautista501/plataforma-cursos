...
class Usuario {
    ...
    private function enviarConfirmacion($email) {
        ...
        try {
            ...
            $mail->Body = 'Gracias por registrarte en nuestra plataforma. Haz clic en el siguiente enlace para confirmar tu cuenta: <a href="http://tusitio.com/api/confirmar?token='.$token.'">Confirmar Cuenta</a>';
    ...
    private function enviarRestablecimiento($email, $token) {
        ...
        try {
            ...
            $mail->Body = 'Haz clic en el siguiente enlace para restablecer tu contraseña: <a href="http://tusitio.com/api/restablecer?token='.$token.'">Restablecer Contraseña</a>';
